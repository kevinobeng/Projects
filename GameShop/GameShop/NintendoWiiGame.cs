...
namespace GameShop
{
    class NintendoWiiGame : Game
    {
        // a NintendoWiiGame also has a payload(an extra attribute)
        public NintendoWiiGame(string gameTitle, string gameDev, Condition condition,
                        decimal originalPrice, DateTime releaseDate)
            : base(gameTitle, gameDev, condition, originalPrice, releaseDate)
        {
            this.console = "NintendoWiiGame";
        }
