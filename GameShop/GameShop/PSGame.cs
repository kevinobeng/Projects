...
using System.Diagnostics; // for Debug.Asser()

namespace GameShop
{
    public class PSGame : Game 
    {
        // a PSGame also has a payload (an extra attribute)
        public PSGame(string gameTitle, string gameDev, Condition condition,
